...
exports.getAllProducts = catchAsyncErrors(async (req, res, next) => {
  ...
  let totalfilteredproducts = await filterproducts.length;
...
exports.updateProduct = async (req, res, next) => {
  ...
  if (typeof req.body.images === "string") {
    ...
    const produc = await Product.findByIdAndUpdate(req.params.id, req.body, {
    new: true,
    runValidators: true,
  ...
  {
  next(new ErrorHander("Product not updated", 404));
  }
};
